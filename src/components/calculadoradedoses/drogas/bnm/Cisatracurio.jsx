...
export default function Cisatracurio() {
	...
	const [ConcentracaoAmpola, setConcentracaoAmpola] = useState(2);
	const [DoseMin] = useState(1);
	const [DoseMax] = useState(3);
	...
	return (
		<div className={classes.root}>
			<span className={classes.droga}>Cisatracúrio</span> <br />
