...
export default function Propofol() {
	...
	const [VolumeDeDroga, setVolumeDeDroga] = useState(80);
	const [VolumeTotal, setVolumeTotal] = useState(80);
	const [ConcentracaoAmpola, setConcentracaoAmpola] = useState(10);
	const [DoseMin] = useState(0.5);
	const [DoseMax] = useState(5);
	...
	return (
		<div className={classes.root}>
			<span className={classes.droga}>Propofol</span> <br />
