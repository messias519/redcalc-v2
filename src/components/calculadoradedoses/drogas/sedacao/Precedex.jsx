...
export default function Precedex() {
	...
	const [ConcentracaoAmpola, setConcentracaoAmpola] = useState(0.1);
	const [DoseMin] = useState(0.2);
	const [DoseMax] = useState(0.7);
	...
	return (
		<div className={classes.root}>
			<span className={classes.droga}>Precedex</span> <br />
